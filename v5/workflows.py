...
from .backend import _import_deeplens, deliver_artifacts, load_lens, persist_output_files


@graph_fn(
    name="deeplens_v3_optimize_workflow",
    inputs=[
        "lens_source",
        "goal",
        "constraints",
...
async def deeplens_v3_optimize_workflow(
    ...
    *,
    ...
    _geo_lens, _create_lens = _import_deeplens()
    ...
    if "zmx" in export_formats:
        try:
            ...
            context.logger().warning("deeplens_v5: optimize workflow failed to write zmx", exc_info=True)
